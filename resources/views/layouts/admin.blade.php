  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">Dev_Tokyo</div>
      </a>
        ...
        <li class="nav-item">
          ...
          <div id="collapsePost" class="collapse" aria-labelledby="headingPost" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              <a class="collapse-item" href="{{ route('admin.posts.index') }}">Lists</a>
              <a class="collapse-item" href="{{ route('admin.posts.add') }}">Add</a>
            </div>
          </div>
        </li>
      @endcan
      ...
      @can('groups')
        <li class="nav-item">
          <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseGroupsUser"
            aria-expanded="true" aria-controls="collapseGroupsUser">
            <i class="fas fa-fw fa-cog"></i>
            <span>Groups user</span>
          </a>
          <div id="collapseGroupsUser" class="collapse" aria-labelledby="headingPost" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              <a class="collapse-item" href="{{ route('admin.groups.index') }}">Lists</a>
              <a class="collapse-item" href="{{ route('admin.groups.add') }}">Add</a>
            </div>
          </div>
        </li>
      @endcan
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                ...
                <img class="img-profile rounded-circle" src="{{ asset('admins') }}/img/undraw_profile.svg">
              </a>
